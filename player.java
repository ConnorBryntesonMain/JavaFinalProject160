...
public class player<X, Y> extends Stock {
    ...
    int totalTurns = 5;
    /**
     * We are using this as a way to make sure that we can keep teh turns orgnized
     ...
     *              This is meant to grab and display your name that way it feels
     *              more personal
     */
    ...
    // nextInput is really important as it is holder varible for all information
    // inputed by the user
    String nextInput;

    /**
     * This is action, also known as all the moving parts of the code. It holds all
     * the actions a player can take in there
     * turn as such it is also where most things went wrong. And it just allows a
     * player to act in the game.
     */
     ...
     * meaning buy then buy
     * 
     * @param input this is the user input
     *
     *              pickStock is how the user is able to pick the stocks they want
     *              to use
     */
    ...
    public void pickStock() throws InterruptedException {
        ...
        while (count < 3 && arrayIndex.size() < 3) {
            // System.out.println("Debug: Stock.stockList size = " +
            // Stock.stockList.size());
            // System.out.println(
            // "Debug: count = " + count + ", arrayCount = " + arrayCount + ", arrayIndex =
            // " + arrayIndex);
    ...
    // This is the stock list that holds information of stocks that were picked and
    // how much was put into it
    public ArrayList<PurchaseTuple> boughtStocks = new ArrayList<>();

    /**
     * This is users buy action, it allows them to spend up to how much cash they
     * have on a stock
     */
    ...
    void buyAction() throws InterruptedException {
        ...
        for (int i = 0; i < arrayIndex.size(); i++) {
            ...
            if (invest > cash) {
                ...
                GuiFlower
                        .updateQuestionLabel("How much would you like to spend on " + stockList.get(arrayIndex.get(i)));
    ...
    /**
     * This is the sell turn allowing them to sell any stock that they own in the
     * order that they bought the item
     */
